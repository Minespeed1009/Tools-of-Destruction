...
{
	public class ChaosProbeMini : ModProjectile
	{
		public override void SetStaticDefaults() 
		{
			DisplayName.SetDefault("Wow you fucking suck so much omg you really are retarded");
		}
		...
		public override void Kill(int timeLeft)
		{
			for (int i = 0; i < 8; i++)
            {
                int num1 = Dust.NewDust(projectile.position, projectile.width, projectile.height, 74, projectile.velocity.X, projectile.velocity.Y, 0, default(Color), 1.2f);
            }
		}
	}
}