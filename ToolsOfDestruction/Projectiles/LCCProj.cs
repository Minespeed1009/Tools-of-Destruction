...
{
	public class LCCProj : ModProjectile
	{
		...
		public override void AI()
		{
			...
			int num1 = Dust.NewDust(projectile.position, projectile.width, projectile.height, 170, 0, 0, 0, default(Color), 1f);
		...
		public override void Kill(int timeLeft)
		{
			for (int i = 0; i < 8; i++)
            {
                int num1 = Dust.NewDust(projectile.position, projectile.width, projectile.height, 170, 0, 0, 0, default(Color), 0.8f);
            }

			Main.PlaySound(SoundID.Item14, projectile.position);
            Projectile.NewProjectile(projectile.position.X, projectile.position.Y, 0, 0, mod.ProjectileType("LihzardYellowExplosion"), projectile.damage, 0f, 0);
		}
	}
}