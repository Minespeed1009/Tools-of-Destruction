...
{
	public class GASOrbProj : ModProjectile
	{
		public override void SetStaticDefaults() 
		{
			DisplayName.SetDefault("Galactic Orb");
		}
		...
		public override void AI()
		{
            ...
            int num1 = Dust.NewDust(projectile.position, projectile.width, projectile.height, 242, 0, 0, 0, default(Color), 2f);
