...
{
	public class CyclonicTorpedo : ModProjectile
	{
		public override void SetStaticDefaults() 
		{
			DisplayName.SetDefault("Torpedo");
		}
		...
		public override void AI()
		{
			...
			int num1 = Dust.NewDust(projectile.position, projectile.width, projectile.height, 229, 0, 0, 0, default(Color), 2f);
		...
		public override void Kill(int timeLeft)
		{
			for (int i = 0; i < 8; i++)
            {
                int num1 = Dust.NewDust(projectile.position, projectile.width, projectile.height, 229, 0, 0, 0, default(Color), 1.2f);
            }

			Main.PlaySound(SoundID.Item14, projectile.position);
            Projectile.NewProjectile(projectile.position.X, projectile.position.Y, 0, 0, mod.ProjectileType("VortexExplosion"), projectile.damage, 0f, 0);
		}
	}
}